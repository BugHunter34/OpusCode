...
function PageHeader({ eyebrow, title, text, titleHighlight }) {
  return (
    <section className="mx-auto w-full max-w-6xl px-5 pb-8 pt-12 sm:px-8 lg:px-12">
      ...
      {title ? (
        <h1 className="font-display reveal reveal-delay-1 mt-3 text-4xl font-semibold text-white sm:text-5xl">
